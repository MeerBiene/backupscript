...
FILE=$PATHLOCAL/"$NAME"_backup.tar.gz
FILE1=$PATHLOCAL/"$NAME"_backup_1.tar.gz
FILE2=$PATHLOCAL/"$NAME"_backup_2.tar.gz
FILE3=$PATHLOCAL/"$NAME"_backup_3.tar.gz
FILE4=$PATHLOCAL/"$NAME"_backup_4.tar.gz
FILE5=$PATHLOCAL/"$NAME"_backup_5.tar.gz
FILE6=$PATHLOCAL/"$NAME"_backup_6.tar.gz
FILE7=$PATHLOCAL/"$NAME"_backup_7.tar.gz
FILE8=$PATHLOCAL/"$NAME"_backup_8.tar.gz
FILE9=$PATHLOCAL/"$NAME"_backup_9.tar.gz
FILE10=$PATHLOCAL/"$NAME"_backup_10.tar.gz
FILE11=$PATHLOCAL/"$NAME"_backup_11.tar.gz
FILE12=$PATHLOCAL/"$NAME"_backup_12.tar.gz
FILE13=$PATHLOCAL/"$NAME"_backup_13.tar.gz
FILE14=$PATHLOCAL/"$NAME"_backup_14.tar.gz
FILE15=$PATHLOCAL/"$NAME"_backup_15.tar.gz
FILE16=$PATHLOCAL/"$NAME"_backup_16.tar.gz
FILE17=$PATHLOCAL/"$NAME"_backup_17.tar.gz
FILE18=$PATHLOCAL/"$NAME"_backup_18.tar.gz
FILE19=$PATHLOCAL/"$NAME"_backup_19.tar.gz
FILE20=$PATHLOCAL/"$NAME"_backup_20.tar.gz
FILE21=$PATHLOCAL/"$NAME"_backup_21.tar.gz
FILE22=$PATHLOCAL/"$NAME"_backup_22.tar.gz
FILE23=$PATHLOCAL/"$NAME"_backup_23.tar.gz
FILE24=$PATHLOCAL/"$NAME"_backup_24.tar.gz
FILE25=$PATHLOCAL/"$NAME"_backup_25.tar.gz
FILE26=$PATHLOCAL/"$NAME"_backup_26.tar.gz
FILE27=$PATHLOCAL/"$NAME"_backup_27.tar.gz
FILE28=$PATHLOCAL/"$NAME"_backup_28.tar.gz
FILE29=$PATHLOCAL/"$NAME"_backup_29.tar.gz
FILE30=$PATHLOCAL/"$NAME"_backup_30.tar.gz
